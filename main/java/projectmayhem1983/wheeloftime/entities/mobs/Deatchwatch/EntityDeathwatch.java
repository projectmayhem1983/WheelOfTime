...
public class EntityDeathwatch {
	public static void WheelOfTime(){
		registerEntity();
	}
	public static void registerEntity(){
		
		createEntity(EntityDeathwatchMob.class,"Deathwatch Mob",0xFFFFFF, 0x000000);
	...
	public static void createEntity(Class entityClass, String entityName, int solidColor, int spotColor){
		...
		EntityRegistry.addSpawn(entityClass, 100, 1, 2, EnumCreatureType.monster, new BiomeGenBase[]{BiomeGenBase.beach, BiomeGenBase.birchForest,BiomeGenBase.birchForestHills,
